...
${OBJECTDIR}/_ext/957312044/SpriteSheetRendererComponent.o: ../../../src/core/components/SpriteSheetRendererComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/957312044
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../Artemis-Cpp/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/957312044/SpriteSheetRendererComponent.o ../../../src/core/components/SpriteSheetRendererComponent.cpp
